...
export default function PreapprovedCreditCard({
  ...
  return (
    <div className='relative'>
      <Card
        className={`bg-linear-to-br from-green-50 to-green-100 border-green-300 shadow-lg overflow-hidden h-full w-full flex flex-col ${className}`}
      >
        ...
        <CardContent className='space-y-4 flex-1 flex flex-col justify-between p-4'>
          ...
          <div className='bg-white rounded-lg p-3 lg:p-4 border border-green-200 flex-1 flex flex-col justify-center'>
            <div className='flex flex-col xl:flex-row xl:justify-between xl:items-center gap-3 lg:gap-4'>
              <div className='flex items-start gap-3'>
                <BatteryCharging className='text-green-700 w-8 h-8 lg:w-10 lg:h-10 flex-shrink-0 mt-1' />
                <div className='flex-1 min-w-0'>
                  ...
                  <p className='text-sm lg:text-base font-bold text-green-700 mt-1'>
                    {offer.maxAmountText}
                  </p>
                </div>
              </div>
              {!isExpanded && !showDetailsInModal && (
                <Button
                  variant='secondary'
                  className='border-green-600 text-green-700 hover:bg-green-50 hover:border-green-700 hover:text-green-700 w-full xl:w-auto text-xs lg:text-sm px-3 lg:px-4 py-2'
      ...
      >
        <div className='p-6 space-y-6'>
          ...
          <div className='flex gap-4 pt-4'>
            <Button
              className='flex-1 bg-green-700 hover:bg-green-800 text-white text-lg py-3'
              onClick={() => {
                handleCloseModal();
                if (onApply) onApply();
              }}
            ...
            <Button
              variant='secondary'
              className='border-green-600 text-green-700 hover:bg-green-50 hover:text-green-700 hover:border-green-600'

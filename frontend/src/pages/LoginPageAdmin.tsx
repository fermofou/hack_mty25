...
export default function LoginPageAdmin() {
  ...
  const { loginAdmin } = useAuth(); // Get admin login helper from context
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call loginAdmin which will save admin context and localStorage
      await loginAdmin(username, password);
      // Navigate to static dashboard route
